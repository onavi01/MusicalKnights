...
public class FriendlySoldier : MonoBehaviour {
    ...
    /*
    * Checks if the markers leading up to and including a destination marker to the right are free 
    ...
    */
    ...
    /*
    * Finds the next unoccupied marker from a destination marker to the right
    ...
    */
    ...
    /*
    * Moves the troop the specified distance to the right & updates lane marker occupancy
    */
    private IEnumerator MarchTo( int nextMarkerID, float nextMarkerDist ) {
        ...
        if ( nextMarkerID < laneInterface.numMarkers ) {
            ...
            nextMarkerScript.friendlyOccupied = true;
        ...
        /*If at opposing edge, damage lane & destroy this troop*/
            ...
            currLaneScript.DamageEnemyLane(atkDmg);
            Destroy(gameObject);
    ...
    /*
    * Moves the troop to a given point to the right
    */
