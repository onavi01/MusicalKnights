...
namespace MusicalKnights.Entity.Troop {
    ...
    public class Troop : MonoBehaviour {
        ...
        // COMMANDERS
        [HideInInspector] public CommanderController commanderController;
        [HideInInspector] public GameObject commanderObj;
        [HideInInspector] public Commander commander;

        // TROOP STATS, SETTINGS & PARAMETERS
        public int id = -1;
        ...
        public int laneAtkDmg = 1;
        public int numAtksPerTurn = 4;
        ...
        private void Start() {
            ...
            commanderController = GameObject.Find("Commanders").GetComponent<CommanderController>();
        ...
        */
        public IEnumerator MarchToMarker( int destMarkerID, float destMarkerDist, int direction ) {
            ...
            if ( ( direction == 1 && destMarkerID >= laneInterface.numMarkers ) || ( direction == -1 && destMarkerID < 0 ) ) {
                currLane.DamageLane( alliance, laneAtkDmg );
                Die();
                yield break;
            }
        ...
        */
        public IEnumerator AttackOpponent( int targetMarkerID ) {
            ...
            int numAtksPerformed = 0;
            
            inCombat = true;

            //Keep attacking until either the opponent is dead, or the max # of atks has been performed this turn
            while ( numAtksPerformed < numAtksPerTurn ) {
                ...
                if ( _conductor.onBeat ) {
                    ...
                    if ( !startedAtk ) {
                        if ( _conductor.measurePosInBeats == _conductor.beatsPerMeasure - 1 ) {
                            _conductor.mainTrack.PlayOneShot(_conductor.troopAtkSfx, 0.07f);
                            startedAtk = true;
                        }
